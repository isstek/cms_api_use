...
namespace CMSServerConnect
{
    ...
    public class DomainClass
    {
        ...
        public IPAddress IP
        {
            get
            {
                ...
                IPAddress.TryParse(dns, out result);
                return result;
            }
        }
    }

    public class ClientsRequestAnswer
    {
        public string built;
        public string csrf;
        public List<ClientClass> client_list;
    }

    public class DomainRequestAnswer
    {
        public string built;
        public string csrf;
    ...
    public class CMSConnector
    {
        ...
        public List<ClientClass> GetAllClients()
        {
            ...
            try
            {
                ClientsRequestAnswer responseValues = JsonConvert.DeserializeObject<ClientsRequestAnswer>(response);
                return responseValues.client_list;
            }
            catch (Exception e)
            {
        ...
        public List<ClientClass> GetDomainClients()
        {
            uri_base.Path = "api/domains";
            uri_base.Query = CMS_SECRET_KEY_PROP_NAME + "=" + _api_key;
            Uri uri = uri_base.Uri;
            uri_base.Path = "";
            uri_base.Query = "";
        ...
        public DomainClass GetDomainInfo(ClientClass client)
        {
            uri_base.Path = "api/domain/" + client.unid;
            uri_base.Query = CMS_SECRET_KEY_PROP_NAME + "=" + _api_key;
            Uri uri = uri_base.Uri;
            uri_base.Path = "";
            uri_base.Query = "";
            ...
            try
            {
                DomainRequestAnswer responseValues = JsonConvert.DeserializeObject<DomainRequestAnswer>(response);
                return responseValues.domain;
            }
            catch (Exception e)
            {
                Console.WriteLine("ERROR! {0}", e);
